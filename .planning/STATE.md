...
- [Phase 09]: README.md description opens with Mako adds language support verb-phrase following Marketplace convention
- [Phase 09]: CHANGELOG.md [0.1.0] documents all four rename dimensions: display name, plugin ID, vendor, source packages
