...
- [x] 05-03-PLAN.md — Gap closure: fix grammar so END_TAG is included in DEF_TAG/BLOCK_TAG with TEMPLATE_TEXT-only bodies
...
**Plans**: 2 plans
Plans:
- [x] 07-01-PLAN.md — Create MakoCompletionContributor with tag-name and attribute providers, register in plugin.xml
- [x] 07-02-PLAN.md — Write MakoCompletionTest covering COMP-01, COMP-02, and no-false-positives
...
**Success Criteria** (what must be TRUE):
  ...
  3. `./gradlew verifyPlugin` completes without errors against the configured target platform build
...
| 8. Error Annotations and Release Readiness | 0/3 | Not started | - |
