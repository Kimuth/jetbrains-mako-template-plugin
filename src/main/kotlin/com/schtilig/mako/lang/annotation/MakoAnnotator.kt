...
class MakoAnnotator : Annotator {
    ...
    override fun annotate(element: PsiElement, holder: AnnotationHolder) {
        // Guard: skip OuterLanguageElement nodes injected by TemplateLanguageFileViewProvider.
        // Once the FileViewProvider is active, TEMPLATE_TEXT positions in the Mako PSI tree
        // contain OuterLanguageElementImpl nodes. Without this guard, checkForInvalidDirective
        // casts them to MakoTemplateTextContent, causing ClassCastException.
