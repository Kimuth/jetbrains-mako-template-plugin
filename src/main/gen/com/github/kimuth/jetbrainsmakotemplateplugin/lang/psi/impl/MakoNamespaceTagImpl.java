...
public class MakoNamespaceTagImpl extends ASTWrapperPsiElement implements MakoNamespaceTag {

  public MakoNamespaceTagImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MakoVisitor visitor) {
    visitor.visitNamespaceTag(this);
  }
