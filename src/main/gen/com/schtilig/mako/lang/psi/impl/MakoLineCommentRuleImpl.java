...
public class MakoLineCommentRuleImpl extends ASTWrapperPsiElement implements MakoLineCommentRule {

  public MakoLineCommentRuleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MakoVisitor visitor) {
    visitor.visitLineCommentRule(this);
  }
