...
public class MakoInheritTagImpl extends ASTWrapperPsiElement implements MakoInheritTag {

  public MakoInheritTagImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MakoVisitor visitor) {
    visitor.visitInheritTag(this);
  }
