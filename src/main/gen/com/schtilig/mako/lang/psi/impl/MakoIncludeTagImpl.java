...
public class MakoIncludeTagImpl extends ASTWrapperPsiElement implements MakoIncludeTag {

  public MakoIncludeTagImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MakoVisitor visitor) {
    visitor.visitIncludeTag(this);
  }
